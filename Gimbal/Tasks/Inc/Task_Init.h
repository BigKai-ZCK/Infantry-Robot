...
/** Macro Definition **/
	...
	#define Chassis_Speed_Full 2
	#define Chassis_Speed_High 1
...
/**Task Function Declaration**/
	...
	void RefereeConnection_Init(UART_HandleTypeDef *huart);
...
/**Extern Declaration**/
	extern State_Register State_Reg, State_Reg_Last;
	extern RM3508_Type Chassis_Motor[4];
	extern ChassisTypedef Chassis;
	extern float pitch_mec_angle_to_real_angle;
  extern uint8_t break_fast;
	extern QueueHandle_t Queue_CANSend;
	extern QueueHandle_t Queue_StateSend;
	extern uint8_t imu_init_flag;
	extern uint8_t JetsonRestartFlag;

	
	extern TaskHandle_t TaskHandle_CAN;
	extern TaskHandle_t TaskHandle_MotorCtrl;
	...
	extern TaskHandle_t TaskHandle_JetsonComm;
	extern TaskHandle_t TaskHandle_PID;
	extern TaskHandle_t TaskHandle_UI;
	extern TaskHandle_t TaskHandle_LED;
